...
- Create Angular project with ng: `ng new bookshopmanagementsystem.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`bookshopmanagementsystem.client.esproj`).
